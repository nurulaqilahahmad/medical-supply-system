...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Medical Supply Shop</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 text-center">
						...
						<h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">Known for our expertise. <br>Chosen for our care.</h1>
						<h8 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5" style="color: white;">Malaysia's Medical Supply Shop Platform</h8><br><br>
