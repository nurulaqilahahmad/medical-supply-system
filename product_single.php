...
if (isset($_POST['submit2'])) {
  ...
  $action = 0;
  $sql = "INSERT INTO cart (ProductId, CustomerEmail, ProductName, ProductDetails, ProductPrice, ProductImage, ProductCategories, ProductQuantity, SellerEmail) 
                    VALUES(:pid, :customeremail, :productname, :productdetails, :productprice, :productimage, :productcategory, :productquantity, :selleremail)";
            ...
            <div class="row mt-20">
              ...
              <div class="col-md-7">
                <div class="single-product-details">
                  ...
                  <p class="product-location">Ships From: <?php echo htmlentities($result->productLocation); ?></p>
                  ...
                  <?php if ($_SESSION['login']) { ?>
                    <button type="submit" name="submit2" class="btn btn-main mt-20">Add To Cart</button>
                  <?php } else { ?>
                    <a href="customer_login.php" class="btn btn-main mt-20">Add To Cart</a>
                  <?php } ?>
                </div>
              </div>
            </div>
