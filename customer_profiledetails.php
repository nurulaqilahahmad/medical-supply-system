							...
							<form name="profile" method="post">
								...
								<div class="dashboard-wrapper dashboard-user-profile">
									<div class="media">
										...
										<img class="media-object user-img" src="images/<?php echo htmlentities($result->Image); ?>" width="200">&nbsp;&nbsp;&nbsp;
                      <a href="customer_changeimage.php?imgid=<?php echo htmlentities($result->id); ?>" class="btn btn-transparent mt-20">Change Image</a>
										...
										<div class="media-body">
											<ul class="user-profile-list">
												...
												<li><span>Address:</span><?php echo htmlentities($result->Address); ?></li>
												<a href="customer_editprofile.php" class="btn btn-transparent mt-20">Change Details</a>
											</ul>
										</div>
									</div>
								</div>
