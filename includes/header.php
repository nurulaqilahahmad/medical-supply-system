        ...
        <div class="row">
          ...
          <div class="col-md-4 col-xs-12 col-sm-4">
            ...
            <ul class="top-menu text-right list-inline">
              ...
              <!-- Logout -->
              <li class="logout"><a href="customer_logout.php">Logout</a></li><!-- Logout -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mb-sm-3">
                      <ul>
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="product_single.php">Product Details</a></li>
                      </ul>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mb-sm-3">
                      <ul>
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="shop.php">Shop</a></li>
                        <li><a href="customer_login.php">Cart</a></li>
                      </ul>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 mb-sm-3">
                      <ul>
                        <li class="dropdown-header">Layout</li>
                        <li role="separator" class="divider"></li>
                        <li><a href="customer_login.php">Product Details</a></li>
                      </ul>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-12">
                      <ul>
                        <li class="dropdown-header">Dashboard</li>
                        <li role="separator" class="divider"></li>
                        <li><a href="customer_login.php">User Interface</a></li>
                        <li><a href="customer_login.php">Orders</a></li>
                        <li><a href="customer_login.php">Product</a></li>
                        <li><a href="customer_login.php">Profile Details</a></li>
                      </ul>
                    </div>
