...
if (isset($_POST['submit'])) {
  ...
  if ($query->rowCount() > 0) {
    $con = "update customer set MobileNumber=:phone, Address=:address where email=:Email";
                ...
                <div class="dashboard-wrapper dashboard-user-profile">
                  <div class="media">
                    <div class="pull-left text-center" href="#!">
                      ...
                      <a href="customer_changeimage.php?imgid=<?php echo htmlentities($result->id); ?>" class="btn btn-transparent mt-20">Change Image</a>
                    </div>
                    <form class="text-left clearfix" style="text-align: justify;" action="customer_editprofile.php" method="post">
                      <div class="media-body">
                        <ul class="user-profile-list">
                          ...
                          <li><span>Address:</span><input style="width: 50%;" type="text" class="form-control" name="address" placeholder="New Address"></input></li>
