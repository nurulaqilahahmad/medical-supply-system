                        ...
                        <aside class="sidebar">
                            <div class="widget widget-category">
                                ...
                                <ul class="widget-category-list">
                                    ...
                                    <li><a class="active" href="orders_toReceive.php">To Receive</a></li>
                                    <li><a href="orders_completed.php">Completed</a></li>
                                </ul>
                            </div>
                        </aside>
                    </div>
                        ...
                        <div class="dashboard-wrapper user-dashboard">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    $sql = "SELECT * from `order` where CustomerEmail=:customeremail AND Status=1";
