      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <div class="block text-center">
            ...
            <form class="text-left clearfix" action="customer_login.php" method="post">
            ...
            <p class="mt-20"><a href="customer_signup.php"> Create New Account</a></p>
            <!--signin-->
            <p class="mt-20"><a href="customer_forgotpassword.php"> Forgot Your Password</a></p>
            <!--password-->
          </div>
        </div>
      </div>
