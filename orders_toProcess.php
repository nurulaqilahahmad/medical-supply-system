                        ...
                        <aside class="sidebar">
                            <div class="widget widget-category">
                                ...
                                <ul class="widget-category-list">
                                    ...
                                    <li><a class="active" href="orders_toProcess.php">To Process</a></li>
                        ...
                        <div class="dashboard-wrapper user-dashboard">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    $sql = "SELECT * from `order` where CustomerEmail=:customeremail AND Status=0";
